...
/**
 * Alternating deep-dive sections: integrations, visibility, reporting, ERP layer.
 * Shared by the solutions page and the home page.
 */
export async function SolutionsPillars() {
